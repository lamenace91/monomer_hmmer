...
q = Process(target=writer_to_file, args=(done_queue,args.seq_file,args.output_seqfile,args.output_tabfile,args.lgth_seq, args.verbose))
q.start()

for w in xrange(workers):
        p = Process(target=analyse_sequences_oneByone, args=(work_queue,done_queue,args.seq_file,args.mono_file,args.word_size,args.lgth_hit,args.score_hit,args.distance,args.verbose))						
        p.start()
        processes.append(p)
        work_queue.put('STOP')
...
print "Waiting for the writer process ..."
q.join()
